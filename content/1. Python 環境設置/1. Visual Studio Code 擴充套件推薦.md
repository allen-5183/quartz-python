---
title: 1. Visual Studio Code 擴充套件推薦
draft: false
description:
date: 2026-07-14
tags: python
...
- [[../0. AI 與 自動化 與雲端服務/1. 自動化/1. 在 Visual Studio Code IDE 自動開啟專案環境設置]]：延伸應用 VS Code 專案自動化設定技巧。
- [[../0. AI 與 自動化 與雲端服務/1. 自動化/2. 在 Visual Studio Code IDE 開發 Python 程式如何設定除錯]]：安裝 Python 擴充套件後即可進行的除錯功能設定。
