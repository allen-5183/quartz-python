...
1. 建立子類別
   ...
   **子類別**會繼承**父類別**的所有共用屬性和方法，也可以建立屬於自己的屬性和方法。
   ![[assets/1. 物件導向程式開發/IMG-20260807093300028.png|400]]
...
3. 鏈狀繼承
   ![[assets/1. 物件導向程式開發/IMG-20260807093329291.png|400]]
...
5. 多重繼承
  ...
  ![[assets/1. 物件導向程式開發/IMG-20260807093403921.png|400]]

   > [!example]- 程式碼: class08.py
   > ```python {.line-numbers}
   > class Father():         #定義父類別
   >     def say(self):      #定義共用方法
   >         print("明天會更好!")
