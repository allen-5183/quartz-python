...
```
 ...
 > [!example]- 程式碼: overriding_defaults_argus.py
 > ```python
 > class Calculator:
...
```
 ...
 > [!example]- 程式碼: overriding_args.py
 > ```python
 > class Calculator:
 > 
 >     def add(self, *args):
...
```
 ...
 > [!example]- 程式碼: overriding_singledispatchmethod.py
 > ```python
